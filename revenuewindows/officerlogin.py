...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.option = QtWidgets.QLabel(Dialog)
        self.option.setGeometry(QtCore.QRect(30, 120, 121, 31))
        ...
        self.comboBox1.setGeometry(QtCore.QRect(180, 130, 141, 22))
        ...
        self.rst_btn.clicked.connect(self.rstCheck)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.option.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Select Option</span></p></body></html>"))
        self.comboBox1.setItemText(0, _translate("Dialog", "MRO"))
        self.comboBox1.setItemText(1, _translate("Dialog", "VRO"))
        self.comboBox1.setItemText(2, _translate("Dialog", "REO"))
        self.comboBox1.setItemText(3, _translate("Dialog", "System Operator"))
